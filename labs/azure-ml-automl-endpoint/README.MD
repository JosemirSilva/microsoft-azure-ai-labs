...
**Portal relacionado:** [Microsoft Foundry](https://ai.azure.com/) — entrada para projetos e capacidades de IA no Azure (além do **Azure Machine Learning Studio** usado neste lab).
